...
(function() {
  ...
  DOMCursor = (function() {
    ...
    DOMCursor.prototype.show = function() {
      var barRect, posRect, top;
      posRect = this.charRect();
      barRect = $("#leisure_bar")[0].getClientRects()[0];
      top = barRect.width && barRect.top === 0 ? barRect.bottom : 0;
  ...
  MutableDOMCursor = (function(_super) {
    ...
    MutableDOMCursor.prototype.setFilter = function(f) {
      this.filter = f;
      return this;
    };
